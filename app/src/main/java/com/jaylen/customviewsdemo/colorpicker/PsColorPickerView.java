 ...
 * @since 2017/08/02
 */
public class PsColorPickerView extends View {
   ...
   public PsColorPickerView(Context context) {
      this(context, null);
   }

   public PsColorPickerView(Context context, AttributeSet attrs) {
      this(context, attrs, 0);
   }

   public PsColorPickerView(Context context, AttributeSet attrs, int defStyle) {
